...
void affichage_resultats_du_kernel(float *matrice1, float *matrice2, float *matrice_res, float *matrice_ref, int taille_des_matrices_carree, float temps_en_milisecondes, float octets_echanges, bool affiche)
{
	affichage_performance(temps_en_milisecondes, octets_echanges);
	...
	if (affiche == true)
	{
		...
		std::cout << " resultat : " << std::endl;
		afficher_matrice(matrice_res, taille_des_matrices_carree);
		std::cout << " resultat cpu: " << std::endl;
		afficher_matrice(matrice_ref, taille_des_matrices_carree);
	}
}